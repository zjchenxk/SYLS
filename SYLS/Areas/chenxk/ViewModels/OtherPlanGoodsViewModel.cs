...
{
    public class OtherPlanGoodsViewModel
    {
        /// <summary>
        /// 货物编码
        /// </summary>
        ...
        [GreaterThanZero(ErrorMessageResourceName = "PackagesNotGreaterThanZero", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        ...
        [GreaterThanZero(ErrorMessageResourceName = "TunnagesNotGreaterThanZero", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
