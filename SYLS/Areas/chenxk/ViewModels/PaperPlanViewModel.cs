...
{
    public class PaperPlanViewModel
    {
        /// <summary>
        /// 计划编码
        /// </summary>
        ...
        /// </summary>
        [StringLength(20)]
        [Display(Name = "OrderNo", ResourceType = typeof(InnoSoft.LS.Resources.Labels))]
        ...
        /// </summary>
        [Required]
        [Display(Name = "IsInstalment", ResourceType = typeof(InnoSoft.LS.Resources.Labels))]
        ...
        /// 货物集合
        /// </summary>
        public List<PaperPlanGoodsViewModel> Goods { get; set; }
    }
}