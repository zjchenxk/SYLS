...
{
    public class MoveWarehouseBillGoodsViewModel
    {
        /// <summary>
        /// 记录编码
        /// </summary>
        ...
        public long MoveWarehouseBillId { get; set; }
        ...
        [Required]
        [StringLength(10)]
        [Display(Name = "NewLocation", ResourceType = typeof(InnoSoft.LS.Resources.Labels))]
        ...
        [Required]
        [RegularExpression(@"^\d+$", ErrorMessageResourceName = "NotValidInteger", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        [GreaterThanOrEqualZero(ErrorMessageResourceName = "NewPackagesNotGreaterThanOrEqualZero", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        [Display(Name = "NewPieces", ResourceType = typeof(InnoSoft.LS.Resources.Labels))]
        ...
        [Required]
        [RegularExpression(@"^\d+(\.\d+)?$", ErrorMessageResourceName = "NotValidNumeric", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        [GreaterThanOrEqualZero(ErrorMessageResourceName = "NewTunnagesNotGreaterThanOrEqualZero", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        [Display(Name = "NewTunnages", ResourceType = typeof(InnoSoft.LS.Resources.Labels))]
        public decimal NewTunnages { get; set; }
        ...
        [Required]
        [RegularExpression(@"^\d+(\.\d+)?$", ErrorMessageResourceName = "NotValidNumeric", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        [GreaterThanOrEqualZero(ErrorMessageResourceName = "NewPilesNotGreaterThanOrEqualZero", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        [Display(Name = "NewPiles", ResourceType = typeof(InnoSoft.LS.Resources.Labels))]
        public decimal NewPiles { get; set; }
        ...
        [Required]
        [RegularExpression(@"^\d+(\.\d+)?$", ErrorMessageResourceName = "NotValidNumeric", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        [GreaterThanOrEqualZero(ErrorMessageResourceName = "NewTenThousandsNotGreaterThanOrEqualZero", ErrorMessageResourceType = typeof(InnoSoft.LS.Resources.Strings))]
        [Display(Name = "NewTenThousands", ResourceType = typeof(InnoSoft.LS.Resources.Labels))]
        public decimal NewTenThousands { get; set; }
