...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.StatOrganTotalOutput %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        ...
        <li><a href="/chenxk/Statistics/ExportOrganTotalOutput/" onclick="javascript:objMain.objWorkspace.objContent.export(this.href);return false;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    ...
    <div id="dialogCondition" title="" style="">
        <% Html.RenderPartial("StatOrganTotalOutputCondition"); %>
    </div>
    <script type="text/javascript">
        ...
        function WorkspaceContent() {
            ...
            this.search = function () {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 7010, strPermission: "AllowSearch" }, function (ret) {
                    if (ret == false) {
                    ...
                    //初始化控件数据
                    $("#formStatOrganTotalOutputCondition #StartTime").val($.jStorage.get("StatOrganTotalOutputCondition_StartTime", ""));
                    $("#formStatOrganTotalOutputCondition #EndTime").val($.jStorage.get("StatOrganTotalOutputCondition_EndTime", ""));
                    $("#formStatOrganTotalOutputCondition #OrganId").val($.jStorage.get("StatOrganTotalOutputCondition_OrganId", ""));
            ...
            this.export = function (action) {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 7010, strPermission: "AllowExport" }, function (ret) {
                    if (ret == false) {
                        alert("<%: InnoSoft.LS.Resources.Strings.NoPermission %>");
                        return;
                    }
                    ...
                    if ($("#grid1").jqGrid("getGridParam", "records") == 0) {
                        ...
                        if ($("#formStatOrganTotalOutputCondition #StartTime").val().trim() == "" && $("#formStatOrganTotalOutputCondition #EndTime").val().trim() == "") {
                    ...
                    var url = action + "?" +
                    "startTime=" + $("#formStatOrganTotalOutputCondition #StartTime").val().trim() + "&" +
                    "endTime=" + $("#formStatOrganTotalOutputCondition #EndTime").val().trim() + "&" +
                    "organId=" + $("#formStatOrganTotalOutputCondition #OrganId").val().trim();
        ...
        $(document).ready(function () {
            ...
            $("#grid1").jqGrid({
                ...
                colModel: [
                    ...
                    { name: "OrganName", index: "OrganName", width: 120 },
                ...
                gridComplete: function () {
                    ...
                    if (datatype != "local") {
                        $("#tdTimeSpan").text("<%: InnoSoft.LS.Resources.Labels.TimeSpan %>:" + $("#formStatOrganTotalOutputCondition #StartTime").val().trim() + " ～ " + $("#formStatOrganTotalOutputCondition #EndTime").val().trim());
            ...
            $("#dialogCondition").dialog({
                ...
                buttons: {
                    "<%: InnoSoft.LS.Resources.Buttons.Ok %>": function () {
                        if ($("#formStatOrganTotalOutputCondition").valid()) {
                            //缓存查询条件
                            $.jStorage.set("StatOrganTotalOutputCondition_StartTime", $("#formStatOrganTotalOutputCondition #StartTime").val().trim());
                            $.jStorage.set("StatOrganTotalOutputCondition_EndTime", $("#formStatOrganTotalOutputCondition #EndTime").val().trim());
                            $.jStorage.set("StatOrganTotalOutputCondition_OrganId", $("#formStatOrganTotalOutputCondition #OrganId").val().trim());
                            ...
                            $("#grid1").jqGrid("setGridParam", {
                                url: "/chenxk/Statistics/LoadStatOrganTotalOutputGrid/",
                                datatype: "json",
                                postData: {
                                    startTime: $("#formStatOrganTotalOutputCondition #StartTime").val().trim(),
                                    endTime: $("#formStatOrganTotalOutputCondition #EndTime").val().trim(),
