<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<SYLS.Areas.chenxk.ViewModels.OtherPlanViewModel>" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        //创建货物表格
        $("#grid1").jqGrid({
            url: "/chenxk/Plan/LoadOtherPlanGoodsGrid/<%: Model.Id %>",
            datatype: "json",
            mtype: "GET",
