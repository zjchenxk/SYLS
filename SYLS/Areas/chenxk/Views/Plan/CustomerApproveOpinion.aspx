...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.CustomerApproveOpinion %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        <li><a href="/chenxk/Plan/CustomerAgreeDeliverPlan/" onclick="javascript:objMain.objWorkspace.objContent.agreePlan(this.href);return false;">
            ...
            this.agreePlan = function (action) {
                $.post(action, { id: '<%: ViewData["id"] %>' }, function (ret) {
                    ...
                    if (ret.Success == false) {
                        ...
                        location.replace("/chenxk/Plan/CustomerApprovePaperPlans/");
                    }
                });
            };
            //不同意计划
            ...
            $("#dialogOpinion").dialog({
                ...
                buttons: {
                    "<%: InnoSoft.LS.Resources.Buttons.Ok %>": function () {
                        ...
                        $.post("/chenxk/Plan/CustomerDisagreeDeliverPlan/", { id: '<%: ViewData["id"] %>', disagreeopinion: $("#txtDisagreeOpinion").val().trim() }, function (ret) {
                            $.unblockUI();
