...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ModifyPaperPlan %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    <% using (Html.BeginForm("ModifyPaperPlan", "Plan", FormMethod.Post, new { id = "form1" }))
       { %>
    <fieldset>
        <legend>
        ...
        $(document).ready(function () {
                            ...
                            for (var i = 0; i < grid2Rows.length; i++) {
                                ...
                                if (actualPackages > 0 || actualTunnages > 0) {
                                    ...
                                    if (actualPackages > 0 && actualTunnages > 0) {
                                        ...
                                        pieceWeight = parseFloat(grid2Row.PieceWeight);
                                    }
            ...
            $("#form1").submit(function () {
                if ($(this).valid()) {
                    ...
                    if (parseFloat(footerData.Tunnages) < 0) {
