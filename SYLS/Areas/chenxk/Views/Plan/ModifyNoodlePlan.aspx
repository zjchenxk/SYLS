...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ModifyNoodlePlan%>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    <% using (Html.BeginForm("ModifyNoodlePlan", "Plan", FormMethod.Post, new { id = "form1" }))
       { %>
    <fieldset>
        <legend>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //创建货物表格
            $("#grid1").jqGrid({
                url: "/chenxk/Plan/LoadNoodlePlanGoodsGrid/" + encodeURI($("#form1 #Id").val().trim()),
                datatype: "json",
                mtype: "GET",
