...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.CustomerApprovePaperPlans %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        <li><a href="/chenxk/Plan/CustomerApproveOpinion/" onclick="javascript:objMain.objWorkspace.objContent.approveOpinion(this.href);return false;">
    ...
    <script type="text/javascript">
        ...
        function WorkspaceContent() {
            ...
            this.approveOpinion = function (action) {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 1060, strPermission: "AllowApprove" }, function (ret) {
                    if (ret == false) {
        ...
        $(document).ready(function () {
            ...
            $("#grid1").jqGrid({
                url: "/chenxk/Plan/LoadCustomerApprovePaperPlansGrid/",
                datatype: "json",
                mtype: "GET",
                colNames: ["<%: InnoSoft.LS.Resources.Labels.PlanId %>", "<%: InnoSoft.LS.Resources.Labels.PlanNo %>", "<%: InnoSoft.LS.Resources.Labels.CustomerName %>", "<%: InnoSoft.LS.Resources.Labels.ShipmentNo %>", "<%: InnoSoft.LS.Resources.Labels.DeliveryNo %>", "<%: InnoSoft.LS.Resources.Labels.ReceiverName %>", "<%: InnoSoft.LS.Resources.Labels.ReceiverAddress %>", "<%: InnoSoft.LS.Resources.Labels.PlanType %>"],
                colModel: [
