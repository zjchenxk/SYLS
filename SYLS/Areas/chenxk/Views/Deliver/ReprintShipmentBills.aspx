...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ReprintShipmentBills %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        ...
        <li><a href="/chenxk/Deliver/ReprintShipmentBill/" onclick="javascript:objMain.objWorkspace.objContent.print(this.href);return false;">
    ...
    <div id="dialogSearch" title="">
        ...
        <table>
            ...
            <tr>
                <td>
                    <div class="editor-label-right">
                        <label for="ShipmentBillNo">
                            <%: InnoSoft.LS.Resources.Labels.ShipmentBillNo %></label>
                    </div>
                </td>
                <td>
                    <div class="editor-field">
                        <input class="text-box single-line" data-val="true" data-val-length="<%: InnoSoft.LS.Resources.Strings.ShipmentBillNoMaxLengthIs20 %>"
                            data-val-length-max="20" id="ShipmentBillNo" name="ShipmentBillNo" type="text"
                            value="" /><br />
                        <span class="field-validation-valid" data-valmsg-for="ShipmentBillNo" data-valmsg-replace="true">
                        </span>
                    </div>
                </td>
            </tr>
    ...
    <script type="text/javascript">
        ...
        function WorkspaceContent() {
            ...
            this.search = function () {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 3070, strPermission: "AllowSearch" }, function (ret) {
                    if (ret == false) {
                        alert("<%: InnoSoft.LS.Resources.Strings.NoPermission %>");
                        return;
                    }

                    $("#formSearch #StartTime").val($.jStorage.get("ReprintShipmentBillsCondition_StartTime", ""));
                    $("#formSearch #EndTime").val($.jStorage.get("ReprintShipmentBillsCondition_EndTime", ""));
                    $("#formSearch #ShipmentBillNo").val($.jStorage.get("ReprintShipmentBillsCondition_ShipmentBillNo", ""));
                    $("#formSearch #CustomerName").val($.jStorage.get("ReprintShipmentBillsCondition_CustomerName", ""));
                    $("#formSearch #CarNo").val($.jStorage.get("ReprintShipmentBillsCondition_CarNo", ""));
            ...
            this.print = function (action) {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 3070, strPermission: "AllowPrint" }, function (ret) {
                    if (ret == false) {
                        alert("<%: InnoSoft.LS.Resources.Strings.NoPermission %>");
                        return;
                    }
                    ...
                    for (var i = 0; i < ids.length; i++) {
                        ...
                        if (data.PlanType != planType) {
                            if (planType == "") {
                                ...
                                alert("<%: InnoSoft.LS.Resources.Strings.CanNotPrintShipmentBillMixed %>");
                                return;
                            }
                        }
                    }
                ...
                buttons: {
                    "<%: InnoSoft.LS.Resources.Buttons.Ok %>": function () {
                        if ($("#formSearch").valid()) {
                            ...
                            //缓存查询条件
                            $.jStorage.set("ReprintShipmentBillsCondition_StartTime", $("#formSearch #StartTime").val().trim());
                            $.jStorage.set("ReprintShipmentBillsCondition_EndTime", $("#formSearch #EndTime").val().trim());
                            $.jStorage.set("ReprintShipmentBillsCondition_ShipmentBillNo", $("#formSearch #ShipmentBillNo").val().trim());
                            $.jStorage.set("ReprintShipmentBillsCondition_CustomerName", $("#formSearch #CustomerName").val().trim());
                            $.jStorage.set("ReprintShipmentBillsCondition_CarNo", $("#formSearch #CarNo").val().trim());
                            ...
                            $("#grid1").jqGrid("setGridParam", {
                                url: "/chenxk/Deliver/LoadReprintShipmentBillsGrid/",
                                datatype: "json",
                                postData: {
                                    startTime: $("#formSearch #StartTime").val().trim(),
                                    endTime: $("#formSearch #EndTime").val().trim(),
                                    shipmentBillNo: $("#formSearch #ShipmentBillNo").val().trim(),
