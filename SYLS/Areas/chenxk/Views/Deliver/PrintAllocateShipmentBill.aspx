...
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        <li><a href="/chenxk/Deliver/PrintAllocateShipmentBills/" onclick="javascript:location.replace(this.href);return false;">
        ...
        <li><a href="/chenxk/Deliver/SubmitPrintShipmentBill/" onclick="javascript:objMain.objWorkspace.objContent.submit(this.href);return false;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    <div id="shipmentBills" style="margin: 5px 5px;">
        <% Html.RenderPartial("PaperShipmentBill", Model); %>
    </div>
                ...
                if (confirm("<%: InnoSoft.LS.Resources.Strings.SubmitShipmentBillConfirm %>") == true) {
                    ...
                    $.post(action, { id: '<%: ViewData["ShipmentBillId"] %>' }, function (ret) {
                        ...
                        if (ret.Success == false) {
                            ...
                            //存储后续步骤流转路径
                            if (ret.EnterWarehouseBillId == "0") {
                                $.jStorage.set("OutWarehouse_SaveSucceedNext", "/chenxk/Deliver/PrintAllocateShipmentBills/");
                            }
                            else {
                                $.jStorage.set("OutWarehouse_SaveSucceedNext", "/chenxk/Stock/EnterWarehouse/" + ret.EnterWarehouseBillId);
                                $.jStorage.set("EnterWarehouse_SaveSucceedNext", "/chenxk/Deliver/PrintAllocateShipmentBills/");
                            }
                            location.replace("/chenxk/Stock/OutWarehouse/" + ret.OutWarehouseBillId);
                        }
                    });
                }
            };
