<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Workspace.master"
    Inherits="System.Web.Mvc.ViewPage<SYLS.Areas.chenxk.ViewModels.ShipmentBillViewModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ModifyShipmentBill %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        <li><a href="/chenxk/Deliver/SubmitShipmentBills/" onclick="javascript:location.replace(this.href);return false;">
            <img src="<%: Url.Content("~/Content/Images/051.png") %>" alt="" style="border: none;" /><%:InnoSoft.LS.Resources.Menus.Back %></a></li>
        <li><a href="/chenxk/Deliver/ModifyShipmentBill/" onclick="javascript:objMain.objWorkspace.objContent.save(this.href);return false;">
                ...
                <td>
                    <div class="editor-field">
                        ...
                        <span class="formInfo"><a href="/Help/TransportChargeExpression/?width=350" class="jTip"
                            id="tooltipTransportChargeExpression" name="<%: InnoSoft.LS.Resources.Titles.Tooltip %>">?</a></span>
                ...
                <td>
                    <div class="editor-field">
                        ...
                        <span class="formInfo"><a href="/Help/TransportPriceExpression/?width=350" class="jTip"
                            id="tooltipTransportPriceExpression" name="<%: InnoSoft.LS.Resources.Titles.Tooltip %>">?</a></span>
    ...
    <script type="text/javascript">
            ...
            this.save = function (action) {
                ...
                for (var i = 0; i < rows.length; i++) {
                    ...
                    if (row.Location == null || row.Location == "") {
                        alert("<%: InnoSoft.LS.Resources.Strings.LocationCanNotEmpty %>");
                        return;
                    }
                ...
                if ($("#form1").valid()) {
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        var g = {
                            "Id": row.Id,
                            "ShipmentBillId": '<%: ViewData["ShipmentBillId"] %>',
                            "GoodsId": row.GoodsId,
                    ...
                    $.ajax({
                        ...
                        success: function (ret) {
                            ...
                            if (ret != null && ret != "") {
                                ...
                                location.replace('/chenxk/Deliver/PrintShipmentBill/<%: ViewData["ShipmentBillId"] %>');
                            }
                        },
        ...
        $(document).ready(function () {
            ...
            $("#grid1").jqGrid({
                ...
                datatype: "json",
                mtype: "GET",
                postData: { shipmentBillId: '<%: ViewData["ShipmentBillId"] %>' },
                colNames: [
                    ...
                    "<%: InnoSoft.LS.Resources.Labels.OldLocation %>",
                ...
                colModel: [
                    ...
                    { name: "Location", index: "Location", width: 50, align: "center", editable: true },
                    ...
                    { name: "OldLocation", index: "OldLocation", width: 50, align: "center", hidden: true },
                ...
                beforeEditCell: function (rowid, cellname, value, iRow, iCol) {
                    ...
                    objMain.objWorkspace.objContent.selectedRowLocation = data.OldLocation;
                ...
                afterSaveCell: function (rowid, cellname, value, iRow, iCol) {
                    ...
                    if (cellname == "Location") {
                        ...
                        if (value != undefined && value != null && value != "") {
                            ...
                            for (var i = 0; i < rows.length; i++) {
                                var row = rows[i];
                                if (row.Location == value && (i + 1) != iRow) {
                                    $("#grid1").jqGrid("setRowData", rowid, { Location: objMain.objWorkspace.objContent.selectedRowLocation });
                                    alert("<%: InnoSoft.LS.Resources.Strings.LocationIsExists %>");
                                    break;
                                }
                            }
                        }
                    }
                    else if (cellname == "Packages") {
                        //检查件数
