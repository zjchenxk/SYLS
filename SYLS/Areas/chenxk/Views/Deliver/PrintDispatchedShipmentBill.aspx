...
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        <li><a href="/chenxk/Deliver/PrintDispatchedShipmentBills/" onclick="javascript:location.replace(this.href);return false;">
                    ...
                    $.post(action, { id: '<%: ViewData["ShipmentBillId"] %>' }, function (ret) {
                        ...
                        if (ret.Success == false) {
                            ...
                            if (ret.EnterWarehouseBillId == "0") {
                                $.jStorage.set("OutWarehouse_SaveSucceedNext", "/chenxk/Deliver/PrintDispatchedShipmentBills/");
                            }
                            else {
                                $.jStorage.set("OutWarehouse_SaveSucceedNext", "/chenxk/Stock/EnterWarehouse/" + ret.EnterWarehouseBillId);
                                $.jStorage.set("EnterWarehouse_SaveSucceedNext", "/chenxk/Deliver/PrintDispatchedShipmentBills/");
                            }
