...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.OutWarehouse %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    ...
    <div id="dialogGoods" title="">
        <% Html.RenderPartial("OutWarehouseBillGoods", Model.Goods[0]); %>
    </div>
    <script type="text/javascript">
        ...
        function WorkspaceContent() {
            ...
            this.newGoods = function () {
                ...
                //设置货物编号可写
                $("#formOutWarehouseBillGoods #GoodsNo").removeAttr("readonly");
            ...
            this.modifyGoods = function () {
                ...
                $("#formOutWarehouseBillGoods #GoodsId").val(data.GoodsId);
                $("#formOutWarehouseBillGoods #GoodsNo").val(data.GoodsNo);
                $("#formOutWarehouseBillGoods #GoodsName").val(data.GoodsName);
                $("#formOutWarehouseBillGoods #Brand").val(data.Brand);
                $("#formOutWarehouseBillGoods #SpecModel").val(data.SpecModel);
                $("#formOutWarehouseBillGoods #GWeight").val(data.GWeight);
                $("#formOutWarehouseBillGoods #Grade").val(data.Grade);
                    ...
                    gridComplete: function () {
                        ...
                        if (rowids.length > 0) {
                            $("#grid2").jqGrid("setRowData", rowids[0], {
                                ...
                                ActualPiles: data.Piles,
                                ActualTenThousands: data.TenThousands
                            });
                        }
                    }
                });
                ...
                //设置货物编号只读
                $("#formOutWarehouseBillGoods #GoodsNo").attr("readonly", "readonly");
            ...
            this.save = function () {
                if ($("#form1").valid()) {
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        var g = {
                            "Id": row.Id,
                            "OutWarehouseBillId": $("#form1 #Id").val().trim(),
                            "GoodsId": row.GoodsId,
                            "GoodsNo": row.GoodsNo,
                    ...
                    var o = {
                        ...
                        "OutType": $("#form1 #OutType").val().trim(),
                    ...
                    $.ajax({
                        ...
                        success: function (ret) {
                            ...
                            if (ret != null && ret != "") {
                                ...
                                var url = $.jStorage.get("OutWarehouse_SaveSucceedNext", "");
                                $.jStorage.set("OutWarehouse_SaveSucceedNext", "");
                                ...
                                if (url != "") {
                                    ...
                                    location.replace("/chenxk/Stock/OutWarehouse/");
                                }
                            }
                        },
        ...
        $(document).ready(function () {
            ...
            if ($("#form1 #Id").val().trim() != null && $("#form1 #Id").val().trim() != "" && $("#form1 #Id").val().trim() != "0") {
                ...
                $("#form1 #OutType").attr("disabled", "disabled");
                $("#form1 #ReceiverName").attr("disabled", "disabled");
                $("#form1 #ReceiverCountry").attr("disabled", "disabled");
                $("#form1 #ReceiverProvince").attr("disabled", "disabled");
                $("#form1 #ReceiverCity").attr("disabled", "disabled");
                $("#form1 #ReceiverAddress").attr("disabled", "disabled");
                $("#form1 #ReceiverContact").attr("disabled", "disabled");
                $("#form1 #ReceiverContactTel").attr("disabled", "disabled");
                $("#form1 #ReceiveType").attr("disabled", "disabled");
                $("#form1 #CarNo").attr("disabled", "disabled");
                $("#form1 #TrailerNo").attr("disabled", "disabled");
                $("#form1 #CarrierName").attr("disabled", "disabled");
                $("#form1 #PayerName").attr("disabled", "disabled");
                $("#form1 #IsConsigning").attr("disabled", "disabled");
                $("#form1 #ConsignedDeliveryNo").attr("disabled", "disabled");
                $("#form1 #Warehouse").attr("disabled", "disabled");
            ...
            //如果是划拨出库，则禁用力支费编辑框，2015.1.4注释
            //if ($("#form1 #OutType").val().trim() == "<%: InnoSoft.LS.Resources.Options.AllocateGoods %>") {
            ...
            $("#form1 #OutType").change(function () {
                ...
                //}
                //else {
                //    $("#form1 #ForceFee").removeAttr("disabled");
                //}
            });
            ...
            //创建货物表格
            $("#grid1").jqGrid({
                url: "/chenxk/Stock/LoadOutWarehouseBillAllGoodsGrid",
                datatype: "json",
                mtype: "GET",
                postData: { outWarehouseBillId: $("#form1 #Id").val().trim() },
                colNames: [
            ...
            $("#dialogGoods").dialog({
                ...
                buttons: {
                    "<%: InnoSoft.LS.Resources.Buttons.Ok %>": function () {
                        //检查货物编码
                        if ($("#formOutWarehouseBillGoods #GoodsNo").val().trim() == null || $("#formOutWarehouseBillGoods #GoodsNo").val().trim() == "") {
                        ...
                        if (totalActualTunnages == 0 && totalActualPiles == 0) {
                            alert("<%: InnoSoft.LS.Resources.Strings.NotEnterActualTunnagesOrActualPiles %>");
                            return;
                        }

                        if (totalActualTunnages > 0 && totalActualPackages == 0) {
                            alert("<%: InnoSoft.LS.Resources.Strings.NotEnterActualPackages %>");
                            return;
                        }

                        if (totalActualPiles > 0 && totalActualTenThousands == 0) {
                        ...
                        if (objMain.objWorkspace.objContent.isNewGoods) {
                            ...
                            for (var i = 0; i < grid2Rows.length; i++) {
                                ...
                                if ((actualPackages > 0 && actualTunnages > 0) || (actualPiles > 0 && actualTenThousands > 0)) {
                                    //检查货物是否重复并累计合计数
                                    var totalPackages = 0;
                                    var totalTunnages = 0;
                                    var totalPiles = 0;
                                    ...
                                    for (var n = 0; n < grid1Rows.length; n++) {
                                        ...
                                        totalTenThousands = add(totalTenThousands, parseFloat(grid1Row.TenThousands));
                                    }
                                    ...
                                    var pieceWeight = 0;
                                    if (actualPackages != 0) {
                                        pieceWeight = div(actualTunnages, actualPackages);
                                    }
        ...
        function ComputeForceFee() {
            //2015.1.4注释
            //if ($("#form1 #OutType").val().trim() == "<%: InnoSoft.LS.Resources.Options.DeliverGoods %>") {
                var loadingForceFeePrice = parseFloat($("#form1 #LoadingForceFeePrice").val().trim());
                if (isNaN(loadingForceFeePrice) || loadingForceFeePrice <= 0) {
