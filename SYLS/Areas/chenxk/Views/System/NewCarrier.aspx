...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.NewCarrier %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    <% using (Html.BeginForm("NewCarrier", "System", FormMethod.Post, new { id = "form1" }))
       { %>
    <fieldset>
        <legend>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#grid1").jqGrid({
                ...
                datatype: "local",
                mtype: "GET",
                colNames: ["<%: InnoSoft.LS.Resources.Labels.CarNo %>", "<%: InnoSoft.LS.Resources.Labels.TrailerNo %>", "<%: InnoSoft.LS.Resources.Labels.CarryingCapacity %>"],
                colModel: [
                    ...
                    "<%: InnoSoft.LS.Resources.Buttons.Ok %>": function () {
                        if ($("#formCar").valid()) {
                            if (objMain.objWorkspace.objContent.isNewCar) {
                                ...
                                if (rowcount == 0) {
                                    $("#grid1").jqGrid("addRowData", 1, { CarNo: $("#formCar #CarNo").val().trim(), TrailerNo: $("#formCar #TrailerNo").val().trim(), CarryingCapacity: $("#formCar #CarryingCapacity").val().trim() });
                                }
                                else {
                                    //检查车号是否重复
                                    var rows = $("#grid1").jqGrid("getRowData");
                                    ...
                                    $("#grid1").jqGrid("addRowData", parseFloat(rowidLast) + 1, { CarNo: $("#formCar #CarNo").val().trim(), TrailerNo: $("#formCar #TrailerNo").val().trim(), CarryingCapacity: $("#formCar #CarryingCapacity").val().trim() });
                                }
                            }
                            else {
                                //检查车号是否重复
            ...
            $("#grid2").jqGrid({
                ...
                datatype: "local",
                mtype: "GET",
                colNames: ["<%: InnoSoft.LS.Resources.Labels.DriverName %>", "<%: InnoSoft.LS.Resources.Labels.LicenseNo %>", "<%: InnoSoft.LS.Resources.Labels.MobileTel %>", "<%: InnoSoft.LS.Resources.Labels.HomeTel %>", "<%: InnoSoft.LS.Resources.Labels.CarNo %>"],
                colModel: [
            ...
            $("#grid3").jqGrid({
                ...
                datatype: "local",
                mtype: "GET",
                colNames: ["<%: InnoSoft.LS.Resources.Labels.PlanType %>", "<%: InnoSoft.LS.Resources.Labels.TransportChargeExpression %>", "<%: InnoSoft.LS.Resources.Labels.TransportPriceExpression %>"],
                colModel: [
