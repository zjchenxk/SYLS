...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ImportGoods %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    <form id="form1" action="/chenxk/System/UploadGoodsFile" method="post" enctype="multipart/form-data">
    <fieldset style="border: none;">
        <div class="editor-label">
            <%: InnoSoft.LS.Resources.Labels.UploadFileName %>(<a href="/chenxk/System/DownloadGoodsFile/"><%: InnoSoft.LS.Resources.Labels.ImportFileExample %></a>)
        </div>
