...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ModifyAccount %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    <% using (Html.BeginForm("ModifyAccount", "System", FormMethod.Post, new { id = "form1" }))
       { %>
            ...
            <tr>
                ...
                <td>
                    <div class="editor-field">
                        ...
                        {
                            new SelectListItem{Text = InnoSoft.LS.Resources.Options.Staff, Value = InnoSoft.LS.Resources.Options.Staff},
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            if ($("#AccountType").val().trim() == "<%: InnoSoft.LS.Resources.Options.Staff %>") {
