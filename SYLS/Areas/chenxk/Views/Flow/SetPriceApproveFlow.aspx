...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.SetPriceApproveFlow %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        <li><a href="/chenxk/Flow/NewPriceApproveStep" onclick="javascript:objMain.objWorkspace.objContent.newPriceApproveStep(this.href);return false;">
            <img src="<%: Url.Content("~/Content/Images/034.png") %>" alt="" style="border: none;" /><%:InnoSoft.LS.Resources.Menus.New%></a></li>
        <li><a href="/chenxk/Flow/ModifyPriceApproveStep/" onclick="javascript:objMain.objWorkspace.objContent.modifyPriceApproveStep(this.href);return false;">
            <img src="<%: Url.Content("~/Content/Images/037.png") %>" alt="" style="border: none;" /><%:InnoSoft.LS.Resources.Menus.Modify%></a></li>
        <li><a href="/chenxk/Flow/DeletePriceApproveStep/" onclick="javascript:objMain.objWorkspace.objContent.deletePriceApproveStep(this.href);return false;">
            <img src="<%: Url.Content("~/Content/Images/038.png") %>" alt="" style="border: none;" /><%:InnoSoft.LS.Resources.Menus.Delete%></a></li>
        <li><a href="/chenxk/Flow/MoveUpPriceApproveStep/" onclick="javascript:objMain.objWorkspace.objContent.moveUpPriceApproveStep(this.href);return false;">
            <img src="<%: Url.Content("~/Content/Images/036.png") %>" alt="" style="border: none;" /><%:InnoSoft.LS.Resources.Menus.MoveUp%></a></li>
        <li><a href="/chenxk/Flow/MoveDownPriceApproveStep/" onclick="javascript:objMain.objWorkspace.objContent.moveDownPriceApproveStep(this.href);return false;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function WorkspaceContent() {
            ...
            //新增步骤
            this.newPriceApproveStep = function (action) {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 9072, strPermission: "AllowNew" }, function (ret) {
                    if (ret == false) {
            ...
            //修改步骤
            this.modifyPriceApproveStep = function (action) {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 9072, strPermission: "AllowModify" }, function (ret) {
                    if (ret == false) {
                        alert("<%: InnoSoft.LS.Resources.Strings.NoPermission %>");
                        return;
                    }
            ...
            //删除步骤
            this.deletePriceApproveStep = function (action) {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 9072, strPermission: "AllowDelete" }, function (ret) {
                    if (ret == false) {
                        alert("<%: InnoSoft.LS.Resources.Strings.NoPermission %>");
                        return;
                    }
            ...
            //上移审批步骤
            this.moveUpPriceApproveStep = function (action) {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 9072, strPermission: "AllowModify" }, function (ret) {
                    if (ret == false) {
                        alert("<%: InnoSoft.LS.Resources.Strings.NoPermission %>");
            ...
            //下移审批步骤
            this.moveDownPriceApproveStep = function (action) {
                //检查权限
                $.get("/Common/LoadAccountPermission", { strFuncId: 9072, strPermission: "AllowModify" }, function (ret) {
                    if (ret == false) {
                        alert("<%: InnoSoft.LS.Resources.Strings.NoPermission %>");
        ...
        $(document).ready(function () {
            ...
            $("#grid1").jqGrid({
                url: "/chenxk/Flow/LoadPriceApproveStepsGrid/",
                datatype: "json",
                mtype: "GET",
