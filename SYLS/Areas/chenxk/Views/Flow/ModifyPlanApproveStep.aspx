...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ModifyPlanApproveStep %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    <% using (Html.BeginForm("ModifyPlanApproveStep", "Flow", FormMethod.Post, new { id = "form1" }))
       { %>
    <fieldset>
        <legend>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            //创建条件表格
            $("#grid1").jqGrid({
                url: "/chenxk/Flow/LoadPlanApproveFlowStepConditionsGrid/" + encodeURI($("#form1 #Id").val().trim()),
                datatype: "json",
                mtype: "GET",
