<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<SYLS.Areas.chenxk.ViewModels.ApproveFlowStepConditionViewModel>" %>
<% using (Html.BeginForm("", "", FormMethod.Post, new { id = "formPlanApproveFlowStepCondition" }))
   { %>
<table>
    <tr>
        <td>
        ...
        <td>
            <div class="editor-field">
                <%: Html.DropDownListFor(model => model.FieldName, new SelectListItem[] { new SelectListItem { Text = string.Empty, Value = string.Empty } }, new { style = "font-family: Arial;" })%><br />
