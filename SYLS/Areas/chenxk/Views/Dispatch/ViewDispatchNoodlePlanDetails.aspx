...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ViewDispatchNoodlePlanDetails %>
</asp:Content>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#grid1").jqGrid("setGridParam", {
                onSelectRow: function (rowid, status) {
                    ...
                    $("#grid2").jqGrid("setGridParam", {
                        url: "/chenxk/Dispatch/LoadNoodlePlanGoodsDispatchHistoryGrid/",
            ...
            $("#grid2").jqGrid({
                ...
                colNames: ["<%: InnoSoft.LS.Resources.Labels.DispatchBillId %>", "<%: InnoSoft.LS.Resources.Labels.DispatchTime %>", "<%: InnoSoft.LS.Resources.Labels.CarNo %>", "<%: InnoSoft.LS.Resources.Labels.TrailerNo %>", "<%: InnoSoft.LS.Resources.Labels.Boxes %>", "<%: InnoSoft.LS.Resources.Labels.Tunnages %>"],
                colModel: [
