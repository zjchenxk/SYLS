...
<% using (Html.BeginForm("", "", FormMethod.Post, new { id = "formAddPlanComputeTransportCharges" }))
   { %>
<table>
    <tr>
        <td>
        ...
        <td>
            <div class="editor-field">
                ...
                <span class="formInfo"><a href="/Help/TransportChargeExpression/?width=350" class="jTip"
                    id="tooltipAddPlanTransportChargeExpression" name="<%: InnoSoft.LS.Resources.Titles.Tooltip %>">
                    ?</a></span>
        ...
        <td>
            <div class="editor-field">
                ...
                <span class="formInfo"><a href="/Help/TransportPriceExpression/?width=350" class="jTip"
                    id="tooltipAddPlanTransportPriceExpression" name="<%: InnoSoft.LS.Resources.Titles.Tooltip %>">
                    ?</a></span>
