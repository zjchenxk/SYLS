...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.DispatchOtherPlan %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    ...
    <fieldset>
        ...
        <% Html.RenderPartial("ComputeOtherPlanTransportCharges", Model.DeliverPlans[0]); %>
    </fieldset>
    <script type="text/javascript">
        ...
        function WorkspaceContent() {
            ...
            this.save = function (action) {
                ...
                if ($("#form1").valid() && $("#formComputeOtherPlanTransportCharges").valid()) {
                    //检查录入时间
                    ...
                    //检查运费公式
                    if ($("#formComputeOtherPlanTransportCharges #TransportChargeExpression").val().trim() == "") {
                        alert("<%: InnoSoft.LS.Resources.Strings.NotEnterTransportChargeExpression %>");
                        return;
                    }

                    //检查单价公式
                    if ($("#formComputeOtherPlanTransportCharges #TransportPriceExpression").val().trim() == "") {
                        alert("<%: InnoSoft.LS.Resources.Strings.NotEnterTransportPriceExpression %>");
                        return;
                    }

                    //检查实际单价
                    var actualTransportPrice = parseFloat($("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val().trim());
                    ...
                    //检查运费
                    var transportCharges = parseFloat($("#formComputeOtherPlanTransportCharges #TransportCharges").val().trim());
                    ...
                    var p = {
                        ...
                        "Piles": "0",
                        "TenThousands": "0",
                        "TransportChargeExpression": $("#formComputeOtherPlanTransportCharges #TransportChargeExpression").val().trim(),
                        "TransportPriceExpression": $("#formComputeOtherPlanTransportCharges #TransportPriceExpression").val().trim(),
                        "KM": "0",
                        "AgreementTransportPrice": $("#formComputeOtherPlanTransportCharges #AgreementTransportPrice").val().trim(),
                        "ActualTransportPrice": $("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val().trim(),
                        "TransportCharges": $("#formComputeOtherPlanTransportCharges #TransportCharges").val().trim(),
                        "Remark": $("#formComputeOtherPlanTransportCharges #Remark").val().trim()
                    };
                    deliverPlans.push(p);
        ...
        $(document).ready(function () {
            ...
            $("#form1 #CarNo").autocomplete({
                ...
                change: function (event, ui) {
                    ...
                    $("#formComputeOtherPlanTransportCharges #TransportChargeExpression").val("");
                    $("#formComputeOtherPlanTransportCharges #TransportPriceExpression").val("");
                    $("#formComputeOtherPlanTransportCharges #AgreementTransportPrice").val("0.00");
                    $("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val("0.00");
                    $("#formComputeOtherPlanTransportCharges #TransportCharges").val("0.00");
                    $("#formComputeOtherPlanTransportCharges #Remark").val("");
                            ...
                            $.get("/Common/LoadDeliverPlan", { nPlanId: "<%: Model.DeliverPlans[0].PlanId %>" }, function (ret) {
                                if (ret != null) {
                                    ...
                                    $.get("/Common/LoadCarrierSettlementExpression", { carrierId: $("#form1 #CarrierId").val().trim(), planType: planType }, function (ret) {
                                        if (ret != null) {
                                            $("#formComputeOtherPlanTransportCharges #TransportChargeExpression").val(ret.TransportChargeExpression);
                                            $("#formComputeOtherPlanTransportCharges #TransportPriceExpression").val(ret.TransportPriceExpression);
                                        }
                                        ...
                                        if ($("#form1 #BusinessType").val().trim() == "<%: InnoSoft.LS.Resources.Options.SelfSupport %>") {
                                            $.get("/Common/LoadCustomerTransportPrice", { planId: "<%: Model.DeliverPlans[0].PlanId %>", carType: $("#form1 #CarType").val().trim() }, function (ret) {
                                                $("#formComputeOtherPlanTransportCharges #AgreementTransportPrice").val(ret);
                                                $("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val(ret);
                    ...
                    $("#grid1").jqGrid("setGridParam", {
                        url: "/chenxk/Dispatch/LoadDispatchedOtherPlansGrid/",
                ...
                afterSaveCell: function (rowid, cellname, value, iRow, iCol) {
                    ...
                    if (cellname == "ActualPackages") {
                        ...
                        if (isNaN(actualPackages)) {
                            $("#grid2").jqGrid("setRowData", rowid, { ActualPackages: "0" });
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //9.设置运费公式自动完成
            $("#formComputeOtherPlanTransportCharges #TransportChargeExpression").autocomplete({
                source: transportChargeExpressions,
                change: function (event, ui) {
                    //检查公式
                    var arrTokens = Tokanize($("#formComputeOtherPlanTransportCharges #TransportChargeExpression").val().trim());
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //10.设置单价公式自动完成
            $("#formComputeOtherPlanTransportCharges #TransportPriceExpression").autocomplete({
                source: transportPriceExpressions,
                change: function (event, ui) {
                    //检查公式
                    var arrTokens = Tokanize($("#formComputeOtherPlanTransportCharges #TransportPriceExpression").val().trim());
                    if (arrTokens == null || arrTokens == undefined) {
                        alert("<%: InnoSoft.LS.Resources.Strings.CanNotTokanizeExpression %>");
                        $("#formComputeOtherPlanTransportCharges #TransportPriceExpression").val("");
                    }
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //11.设置协议单价为只读
            $("#formComputeOtherPlanTransportCharges #AgreementTransportPrice").attr("disabled", "disabled");

            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //12.设置实际单价改变事件
            $("#formComputeOtherPlanTransportCharges #ActualTransportPrice").change(function () {
                //检查单价
                var actualTransportPrice = parseFloat($("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val().trim());
                if (isNaN(actualTransportPrice) || actualTransportPrice <= 0) {
                    $("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val("0.00");
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //13.设置运费改变事件
            $("#formComputeOtherPlanTransportCharges #TransportCharges").change(function () {
                //检查运费
                var transportCharges = parseFloat($("#formComputeOtherPlanTransportCharges #TransportCharges").val().trim());
                if (isNaN(transportCharges) || transportCharges <= 0) {
                    $("#formComputeOtherPlanTransportCharges #TransportCharges").val("0.00");
        ...
        function ComputeTransportCharges() {
            try {
                ...
                exp.Expression($("#formComputeOtherPlanTransportCharges #TransportChargeExpression").val().trim());
                ...
                if (isNaN(ret)) {
                    ...
                    $("#formComputeOtherPlanTransportCharges #TransportCharges").val(Math.round(ret * Math.pow(10, 2)) / Math.pow(10, 2));
                }
            }
            catch (e) {
                $("#formComputeOtherPlanTransportCharges #TransportCharges").val("0.00");
        ...
        function ComputeTransportPrice() {
            try {
                var exp = new Expression("");
                exp.Expression($("#formComputeOtherPlanTransportCharges #TransportPriceExpression").val().trim());
                ...
                var ret = exp.Evaluate();
                if (isNaN(ret)) {
                    $("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val("0");
                }
                else {
                    $("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val(Math.round(ret * Math.pow(10, 3)) / Math.pow(10, 3));
                }
            }
            catch (e) {
                $("#formComputeOtherPlanTransportCharges #ActualTransportPrice").val("0");
