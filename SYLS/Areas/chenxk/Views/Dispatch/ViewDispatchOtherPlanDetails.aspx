...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ViewDispatchOtherPlanDetails %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    <% Html.RenderAction("LoadOtherPlanDetails", "Plan", new { id = ViewData["id"] }); %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#grid1").jqGrid("setGridParam", {
                onSelectRow: function (rowid, status) {
                    ...
                    $("#grid2").jqGrid("setGridParam", {
                        url: "/chenxk/Dispatch/LoadOtherPlanGoodsDispatchHistoryGrid/",
            ...
            $("#grid2").jqGrid({
                ...
                colNames: ["<%: InnoSoft.LS.Resources.Labels.DispatchBillId %>", "<%: InnoSoft.LS.Resources.Labels.DispatchTime %>", "<%: InnoSoft.LS.Resources.Labels.CarNo %>", "<%: InnoSoft.LS.Resources.Labels.TrailerNo %>", "<%: InnoSoft.LS.Resources.Labels.Pieces %>", "<%: InnoSoft.LS.Resources.Labels.Tunnages %>"],
                colModel: [
