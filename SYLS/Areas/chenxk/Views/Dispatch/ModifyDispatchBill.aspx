...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.ModifyDispatchBill %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $.jStorage.deleteKey("ModifyDispatchBill_CarNo");
            ...
            $("#form1 #CarNo").autocomplete({
                ...
                change: function (event, ui) {
                        ...
                        $.ajax({
                            ...
                            success: function (ret) {
                                if (ret != null) {
                                    ...
                                    $("#form1 #CarNo").val($.jStorage.get("ModifyDispatchBill_CarNo", ""));
                                    return;
                                }
                                else {
                    ...
                    //#region 修改车号后，在保存之前禁止添加、修改和删除调度计划

                    $("#btnAddPlan").attr("disabled", "disabled");
                    $("#btnModifyPlan").attr("disabled", "disabled");
                    $("#btnDeletePlan").attr("disabled", "disabled");
                    ...
                    //#region 缓存车号
                    $.jStorage.set("ModifyDispatchBill_CarNo", $("#form1 #CarNo").val().trim());
                    //#endregion
