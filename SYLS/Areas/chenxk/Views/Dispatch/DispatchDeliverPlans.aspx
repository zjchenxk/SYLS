...
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <ul id="menu">
        ...
        <li><a href="#">总消耗时间:&nbsp;<span id="TotalTime" style="color: red;"></span>&nbsp;秒，表格1消耗时间:&nbsp;<span id="Grid1Time" style="color: red;"></span>&nbsp;秒，表格2消耗时间:&nbsp;<span id="Grid2Time" style="color: red;"></span>&nbsp;秒</a></li>
    </ul>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    ...
    <input id="Chenxk_ControllerTime" type="hidden" value='<%: ViewData["Chenxk_ControllerTime"].ToString() %>' />
    <script type="text/javascript">
        $.jStorage.set("Chenxk_ControllerTime", $("#Chenxk_ControllerTime").val());
...
$(document).ready(function () {
    ...
    $("#grid1").jqGrid({
        ...
        beforeRequest: function () {
            //记录请求时间
            $.jStorage.set("DispatchDeliverPlans_Grid1_ProcessingTime", formatDate(new Date(), "yyyy-MM-dd HH:mm:ss"));
        },
        ...
        loadComplete: function (data) {
            //计算总消耗时间
            var totalTime = dateDiff('S', $.jStorage.get("DispatchDeliverPlans_RequestTime"), formatDate(new Date(), "yyyy-MM-dd HH:mm:ss"));
            $("#TotalTime").text(totalTime);
            //计算表格1消耗时间
            var gridTime = dateDiff('S', $.jStorage.get("DispatchDeliverPlans_Grid1_ProcessingTime"), formatDate(new Date(), "yyyy-MM-dd HH:mm:ss"));
            $("#Grid1Time").text(gridTime);
        },
    ...
    $("#grid2").jqGrid({
        ...
        beforeRequest: function () {
            //记录请求时间
            $.jStorage.set("DispatchDeliverPlans_Grid2_ProcessingTime", formatDate(new Date(), "yyyy-MM-dd HH:mm:ss"));
        },
        loadError: function (xhr, status, error) {
            if (xhr != null && xhr != undefined && xhr.responseText != null && xhr.responseText != "") alert(xhr.responseText);
        },
        ...
        loadComplete: function (data) {
            ...
            $("#TotalTime").text(totalTime);
            //计算表格2消耗时间
            var gridTime = dateDiff('S', $.jStorage.get("DispatchDeliverPlans_Grid2_ProcessingTime"), formatDate(new Date(), "yyyy-MM-dd HH:mm:ss"));
            $("#Grid2Time").text(gridTime);
        }
    });
