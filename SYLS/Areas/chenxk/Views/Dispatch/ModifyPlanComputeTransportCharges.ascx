...
<% using (Html.BeginForm("", "", FormMethod.Post, new { id = "formModifyPlanComputeTransportCharges" }))
   { %>
<table>
    <tr>
        <td>
        ...
        <td>
            <div class="editor-field">
                ...
                <span class="formInfo"><a href="/Help/TransportChargeExpression/?width=350" class="jTip"
                    id="tooltipModifyPlanTransportChargeExpression" name="<%: InnoSoft.LS.Resources.Titles.Tooltip %>">
                    ?</a></span>
        ...
        <td>
            <div class="editor-field">
                ...
                <span class="formInfo"><a href="/Help/TransportPriceExpression/?width=350" class="jTip"
                    id="tooltipModifyPlanTransportPriceExpression" name="<%: InnoSoft.LS.Resources.Titles.Tooltip %>">
                    ?</a></span>
