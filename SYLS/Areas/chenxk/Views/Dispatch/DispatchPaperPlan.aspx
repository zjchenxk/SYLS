...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.DispatchPaperPlan %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="WorkspaceContent" runat="server">
    ...
    <fieldset>
        ...
        <% Html.RenderPartial("ComputePaperPlanTransportCharges", Model.DeliverPlans[0]); %>
    </fieldset>
    <script type="text/javascript">
        ...
        function WorkspaceContent() {
            ...
            this.save = function (action) {
                ...
                if ($("#form1").valid() && $("#formComputePaperPlanTransportCharges").valid()) {
                    //检查录入时间
                    ...
                    $.get("/Common/LoadDeliverPlan", { nPlanId: "<%: Model.DeliverPlans[0].PlanId %>" }, function (ret) {
                        if (ret != null) {
                            if (ret.ReceiveType == "<%: InnoSoft.LS.Resources.Options.PickUpDelivery %>") {
                                if ($("#formComputePaperPlanTransportCharges #TransportChargeExpression").val().trim() == "") {
                                    alert("<%: InnoSoft.LS.Resources.Strings.NotEnterTransportChargeExpression %>");
                                    return;
                                }

                                if ($("#formComputePaperPlanTransportCharges #TransportPriceExpression").val().trim() == "") {
                                    alert("<%: InnoSoft.LS.Resources.Strings.NotEnterTransportPriceExpression %>");
                                    return;
                                }

                                var actualTransportPrice = parseFloat($("#formComputePaperPlanTransportCharges #ActualTransportPrice").val().trim());
                                ...
                                var transportCharges = parseFloat($("#formComputePaperPlanTransportCharges #TransportCharges").val().trim());
                            ...
                            var p = {
                                ...
                                "Piles": "0",
                                "TenThousands": "0",
                                "TransportChargeExpression": $("#formComputePaperPlanTransportCharges #TransportChargeExpression").val().trim(),
                                "TransportPriceExpression": $("#formComputePaperPlanTransportCharges #TransportPriceExpression").val().trim(),
                                "KM": "0",
                                "AgreementTransportPrice": $("#formComputePaperPlanTransportCharges #AgreementTransportPrice").val().trim(),
                                "ActualTransportPrice": $("#formComputePaperPlanTransportCharges #ActualTransportPrice").val().trim(),
                                "TransportCharges": $("#formComputePaperPlanTransportCharges #TransportCharges").val().trim(),
                                "Remark": $("#formComputePaperPlanTransportCharges #Remark").val().trim()
                            };
                            deliverPlans.push(p);
        ...
        $(document).ready(function () {
            ...
            $("#form1 #CarNo").autocomplete({
                ...
                change: function (event, ui) {
                    ...
                    $("#formComputePaperPlanTransportCharges #TransportChargeExpression").val("");
                    $("#formComputePaperPlanTransportCharges #TransportPriceExpression").val("");
                    $("#formComputePaperPlanTransportCharges #AgreementTransportPrice").val("0.00");
                    $("#formComputePaperPlanTransportCharges #ActualTransportPrice").val("0.00");
                    $("#formComputePaperPlanTransportCharges #TransportCharges").val("0.00");
                    $("#formComputePaperPlanTransportCharges #Remark").val("");
                            ...
                            $.get("/Common/LoadDeliverPlan", { nPlanId: "<%: Model.DeliverPlans[0].PlanId %>" }, function (ret) {
                                if (ret != null) {
                                    ...
                                    $.get("/Common/LoadCarrierSettlementExpression", { carrierId: $("#form1 #CarrierId").val().trim(), planType: planType }, function (ret) {
                                        if (ret != null) {
                                            $("#formComputePaperPlanTransportCharges #TransportChargeExpression").val(ret.TransportChargeExpression);
                                            $("#formComputePaperPlanTransportCharges #TransportPriceExpression").val(ret.TransportPriceExpression);
                                        }
                                        ...
                                        if ($("#form1 #BusinessType").val().trim() == "<%: InnoSoft.LS.Resources.Options.SelfSupport %>") {
                                            $.get("/Common/LoadCustomerTransportPrice", { planId: "<%: Model.DeliverPlans[0].PlanId %>", carType: $("#form1 #CarType").val().trim() }, function (ret) {
                                                $("#formComputePaperPlanTransportCharges #AgreementTransportPrice").val(ret);
                                                $("#formComputePaperPlanTransportCharges #ActualTransportPrice").val(ret);
                    ...
                    $("#grid1").jqGrid("setGridParam", {
                        url: "/chenxk/Dispatch/LoadDispatchedPaperPlansGrid/",
                    ...
                    if (cellname == "ActualPackages") {
                        ...
                        if (isNaN(actualTunnages)) {
                            ...
                            if (actualPackages == 0) {
                                ...
                                $("#grid2").jqGrid("setRowData", rowid, { PieceWeight: Math.round(pieceWeight * Math.pow(10, 6)) / Math.pow(10, 6) });
                            }
                        }
                    }
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //9.设置运费公式自动完成
            $("#formComputePaperPlanTransportCharges #TransportChargeExpression").autocomplete({
                source: transportChargeExpressions,
                change: function (event, ui) {
                    //检查公式
                    var arrTokens = Tokanize($("#formComputePaperPlanTransportCharges #TransportChargeExpression").val().trim());
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //10.设置单价公式自动完成
            $("#formComputePaperPlanTransportCharges #TransportPriceExpression").autocomplete({
                source: transportPriceExpressions,
                change: function (event, ui) {
                    //检查公式
                    var arrTokens = Tokanize($("#formComputePaperPlanTransportCharges #TransportPriceExpression").val().trim());
                    if (arrTokens == null || arrTokens == undefined) {
                        alert("<%: InnoSoft.LS.Resources.Strings.CanNotTokanizeExpression %>");
                        $("#formComputePaperPlanTransportCharges #TransportPriceExpression").val("");
                    }
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //11.设置协议单价为只读
            $("#formComputePaperPlanTransportCharges #AgreementTransportPrice").attr("disabled", "disabled");

            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //12.设置实际单价改变事件
            $("#formComputePaperPlanTransportCharges #ActualTransportPrice").change(function () {
                //检查单价
                var actualTransportPrice = parseFloat($("#formComputePaperPlanTransportCharges #ActualTransportPrice").val().trim());
                if (isNaN(actualTransportPrice) || actualTransportPrice <= 0) {
                    $("#formComputePaperPlanTransportCharges #ActualTransportPrice").val("0.00");
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //13.设置运费改变事件
            $("#formComputePaperPlanTransportCharges #TransportCharges").change(function () {
                //检查运费
                var transportCharges = parseFloat($("#formComputePaperPlanTransportCharges #TransportCharges").val().trim());
                if (isNaN(transportCharges) || transportCharges <= 0) {
                    $("#formComputePaperPlanTransportCharges #TransportCharges").val("0.00");
            ...
            $.get("/Common/LoadDeliverPlan", { nPlanId: "<%: Model.DeliverPlans[0].PlanId %>" }, function (ret) {
                if (ret != null) {
                    ...
                    if (ret.ReceiveType == "<%: InnoSoft.LS.Resources.Options.PickUpSelf %>") {
                        ...
                        $("#formComputePaperPlanTransportCharges #TransportChargeExpression").attr("disabled", "disabled");
                        $("#formComputePaperPlanTransportCharges #TransportPriceExpression").attr("disabled", "disabled");
                        $("#formComputePaperPlanTransportCharges #ActualTransportPrice").attr("disabled", "disabled");
                        $("#formComputePaperPlanTransportCharges #TransportCharges").attr("disabled", "disabled");
                        $("#formComputePaperPlanTransportCharges #Remark").attr("disabled", "disabled");
                    }
                }
            }, "text json").error(function (xhr, status, error) {
                if (xhr != null && xhr != undefined && xhr.responseText != null && xhr.responseText != "") alert(xhr.responseText);
        ...
        function ComputeTransportCharges() {
            try {
                ...
                exp.Expression($("#formComputePaperPlanTransportCharges #TransportChargeExpression").val().trim());
                ...
                if (isNaN(ret)) {
                    ...
                    $("#formComputePaperPlanTransportCharges #TransportCharges").val(Math.round(ret * Math.pow(10, 2)) / Math.pow(10, 2));
                }
            }
            catch (e) {
                $("#formComputePaperPlanTransportCharges #TransportCharges").val("0.00");
        ...
        function ComputeTransportPrice() {
            try {
                var exp = new Expression("");
                exp.Expression($("#formComputePaperPlanTransportCharges #TransportPriceExpression").val().trim());
                ...
                var ret = exp.Evaluate();
                if (isNaN(ret)) {
                    $("#formComputePaperPlanTransportCharges #ActualTransportPrice").val("0");
                }
                else {
                    $("#formComputePaperPlanTransportCharges #ActualTransportPrice").val(Math.round(ret * Math.pow(10, 3)) / Math.pow(10, 3));
                }
            }
            catch (e) {
                $("#formComputePaperPlanTransportCharges #ActualTransportPrice").val("0");
