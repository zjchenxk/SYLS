...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%: InnoSoft.LS.Resources.Titles.DispatchCanPlan %>
</asp:Content>
            ...
            $.get("/Common/LoadDeliverPlan", { nPlanId: "<%: Model.DeliverPlans[0].PlanId %>" }, function (ret) {
                if (ret != null) {
                    ...
                    if (ret.ReceiveType == "<%: InnoSoft.LS.Resources.Options.PickUpSelf %>") {
                        ...
                        $("#formComputeCanPlanTransportCharges #TransportChargeExpression").attr("disabled", "disabled");
                        $("#formComputeCanPlanTransportCharges #TransportPriceExpression").attr("disabled", "disabled");
                        $("#formComputeCanPlanTransportCharges #ActualTransportPrice").attr("disabled", "disabled");
                        $("#formComputeCanPlanTransportCharges #TransportCharges").attr("disabled", "disabled");
                        $("#formComputeCanPlanTransportCharges #Remark").attr("disabled", "disabled");
                    }
                }
            }, "text json").error(function (xhr, status, error) {
                if (xhr != null && xhr != undefined && xhr.responseText != null && xhr.responseText != "") alert(xhr.responseText);
